...
<body>
	...
	<div id="embed_area">
			...
			<table class="table_form has_border">
				<tr class="bottom_border">
					...
					<td class="table_form_field"><input
						class="input_wrapper input_required" type="text" name="penname" /></td>
				</tr>
				<tr class="bottom_border">
					<td class="table_form_label">简介：</td>
					<td class="table_form_field"><textarea
							class="input_wrapper input_required" name="intro"
							style="width: 400px; height: 120px; margin-top: 8px;"></textarea></td>
				</tr>
				<tr class="bottom_border">
				...
				<tr class="bottom_border">
					...
					<td class="table_form_field"><select name="sex"
				...
				<tr class="bottom_border">
					...
					<td class="table_form_field"><input
						class="input_wrapper input_required" type="text" name="cardno" /></td>
				</tr>
				<tr class="bottom_border">
					<td class="table_form_label">联系电话：</td>
					<td class="table_form_field"><input
						class="input_wrapper input_required" type="text" name="phone" /></td>
				</tr>
				<tr class="bottom_border">
					<td class="table_form_label">电子邮件：</td>
					<td class="table_form_field"><input
						class="input_wrapper input_required" type="text" name="email" /></td>
				</tr>
				<tr class="bottom_border">
					<td class="table_form_label">QQ或MSN：</td>
					<td class="table_form_field"><input
						class="input_wrapper input_required" type="text" name="im" /></td>
				</tr>
			</table>
		</form>
		...
		<div
			style="width: 100%; text-align: center; margin: 26px auto 16px auto;">
