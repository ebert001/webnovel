...
function createDivEditorHeader(id) {
	...
	str += '<img src="' + rootPath + '/imgs/text_indent.png" title="增加缩进" onclick="javascript: decorate(\'Indent\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/text_indent_remove.png" title="减少缩进" onclick="javascript: decorate(\'Outdent\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/text_align_left.png" title="居左" onclick="javascript: decorate(\'JustifyLeft\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/text_align_center.png" title="居中" onclick="javascript: decorate(\'JustifyCenter\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/text_align_right.png" title="居右" onclick="javascript: decorate(\'JustifyRight\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/bold.png" title="加粗" onclick="javascript: decorate(\'Bold\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/italic.png" title="倾斜" onclick="javascript: decorate(\'Italic\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/underline.png" title="下划线" onclick="javascript: decorate(\'UnderLine\'); setValue(\'' + id + '\');"/>';
	str += '<img src="' + rootPath + '/imgs/link.png" title="链接" onclick="javascript: decorate(\'CreateLink\'); setValue(\'' + id + '\');"/>';
