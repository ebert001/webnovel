	    ...
	    <form action="" method="post">
	   	<table>
	   		<tr>
	   			<td>用户名：</td>
	   			<td>
	   				<input class="input_wrapper" type="text" name="username">
	   			</td>
	   		</tr>
	   		<tr>
	   			<td>密&nbsp;&nbsp;码：</td>
	   			<td>
	   				<input class="input_wrapper" type="password" name="password">
	   			</td>
	   		</tr>
	   		<tr>
	   			<td>验证码：</td>
	   		...
	   		<tr>
	   			<td colspan="2">
	   				<div style="width: 100%; text-align: center; margin: 26px auto 16px auto;">
				    	<a class="a_btn medium" href="${pageContext.request.contextPath}/User.action?queryOne&uName=">登  录</a>
				    </div>
	   			</td>
	   		</tr>
	   	</table>
